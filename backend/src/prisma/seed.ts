    ...
    const systemRoles: Array<{ name: string; slug: string; description: string; permissions: string[] }> = [
      ...
      },
      {
        ...
        permissions: [
          ...
          'reports.driverTrips','reports.evidence','reports.jobStatus','reports.repFees',
          'reports.repScore','reports.revenue',
          'reports.carJobs','reports.supplierJobs','reports.vehicleCompliance',
