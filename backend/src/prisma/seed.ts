    ...
    const systemRoles: Array<{ name: string; slug: string; description: string; permissions: string[] }> = [
      ...
      },
      {
        ...
        permissions: [
          ...
          'complaints','complaints.view','complaints.transition',
          'complaints.transition.resolve','complaints.transition.cancel',
          'complaints.financial','complaints.financial.viewAmounts','complaints.financial.editAmounts',
          'complaints.charge','complaints.charge.create','complaints.charge.approve',
          'complaints.charge.post','complaints.charge.void','complaints.scorePenalty',
          'complaints.attachments','complaints.attachments.view','complaints.export',
          'complaint-categories','reports.complaints',
          'finance.agentAdjustments','finance.agentAdjustments.view',
          'finance.agentAdjustments.onInvoice','finance.agentAdjustments.creditNote',
      ...
      },
      {
        ...
        permissions: [
          'activity-logs','activity-logs.export',
          'complaints','complaints.view','complaints.addButton','complaints.editButton',
          'complaints.assign','complaints.transition','complaints.transition.review',
          'complaints.transition.reply','complaints.transition.escalate',
          'complaints.attachments','complaints.attachments.view','complaints.attachments.upload',
